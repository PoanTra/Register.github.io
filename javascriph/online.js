...
var languageSelectinfo = {
    បារាំង:{
        ...
        B2:["B2-1", "B2-2", "B2-3","B2-4","B2-5" , "B2-6" , "DELFB2"],
    },
    អង់គ្លេស:{
...
form.addEventListener("submit" , (e) =>{ e.preventDefault()
    ...
    var Text_Know = document.querySelector("#Know").value;
...
const txt18 = document.getElementById('Know');
...
function hidebtn(){
    ...
    const hidetop = document.querySelector('.top-form')
    hidetop.style.display = 'none';
    const hidebuttom = document.querySelector('.bottom-form')
    hidebuttom.style.display = 'none';
    const hideend = document.querySelector('.end-form')
    hideend.style.display = 'none';
}

function showMoreOption(){
    var select = document.getElementById('StudentNO');
    var studentKnow = document.getElementById('KnowOption');
    if(select.value === "ថ្មី"){
